	    ...
	    newLang: function(){
	        $.validationEngineLanguage.allRules = {
	            ...
	            "email": {
	                ...
	                "alertText": " ongeldig, controleer deze aub."
	            },
	            "alwaysGood": {
	            	"regex": /^.*$/,
	            	"alertText": "Goed"
	            ...
	            "ajaxAvailabilityCall": {
	                "url": sr_translations.root + "/wp-admin/admin-ajax.php",
	                // you may want to pass extra data on the ajax call
	                "extraData": '',
	                'extraDataDynamic': '#aankomst,#vertrek,#action',
	                "alertText": "* Periode is niet beschikbaar",
	                "alertTextLoad": "* Beschikbaarheid wordt gecontroleerd, even geduld aub"
	            }
	        };
